...
| <a name="input_promotion_tier"></a> [reader\_independent\_scaling](#input\_reader\_independent\_scaling) | Failover priority. 2 or more allow independent scaling | `number` | `0` | no |
...
| <a name="output_secret_arn"></a> [secret\_arn](#output\_secret\_arn) | The Amazon Resource Name (ARN) for the secret |

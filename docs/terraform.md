...
| <a name="input_enabled_egress"></a> [enabled\_egress](#input\_enabled\_egress) | Whether or not apply the egress security group rule to default security group | `bool` | `true` | no |

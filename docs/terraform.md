...
| <a name="input_enhanced_monitoring_attributes"></a> [enhanced\_monitoring\_attributes](#input\_enhanced\_monitoring\_attributes) | Whether or not to apply the egress security group rule to default security group, defaults to `true` | `list(string)` | <pre>[<br>  "enhanced-monitoring"<br>]</pre> | no |
